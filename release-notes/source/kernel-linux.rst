...
TQ Systems Community BSP for each supported machine.
...
linux-tqs provides the Linux Kernel |linux_tqs_version| from stable mainline
(kernel.org) with TQ Systems embedded module extensions.
